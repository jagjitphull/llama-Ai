...
with gr.Blocks(title="🦙 Smart AI Knowledge Center — Llama 3, CodeLlama, and Google Automation by GNU IT Solutions & Services") as demo:
    ...
    <div style="
        ...
        <img src="https://github.com/jagjitphull/assets_logo/blob/main/Gitss_Metallic_glassy-2.png?raw=true" alt="GNU IT Solutions & Services Logo" style="width:250px; height: auto">
